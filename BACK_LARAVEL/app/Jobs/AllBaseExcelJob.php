...
class AllBaseExcelJob implements ShouldQueue
{
   ...
   public function __construct(
       $semestre_id,$parcour_id,$is_validation,public string $folder
       ){
    ...
    public function handle()
    {
        ...
        foreach ($historiquesChunks as $key => $historiques) {
            ...
            \Excel::store(new MoyenneUeExport($data),"public/".$this->folder."/".$name);
        }
