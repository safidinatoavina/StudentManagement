<template>
    <div class="m-3">
        ...
        <section class="form-group m-2">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 my-2">
                    ...
                    <div class="preview-photo mt-3 position-relative border"  v-show="imageUrl">
                        ...
                        <img :src="imageUrl" class="w-100"  alt="prevue photo" >
                    </div>

                    <div class="preview-photo mt-3" v-if="selected_admin.personne?.photo?.url && !imageUrl">
                        <img :src="selected_admin.personne.photo.url" alt="prevue photo" class="w-100">
                    </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 col-md-6 position-relative">
                    ...
                    placeholder="Ajouter pour changer"
        ...
        <div class="mt-3">
            <button @click="Admin.updateAdmin(formData,showSuccessUpdate,showErrorUpdate,Auth.getUser.id)"
             class="btn btn-primary">
             <span>Enregistrer</span>
             <spinner v-if="Admin.getPending.update_admin"></spinner>
...
<script setup>
    ...
    const showSuccessUpdate = () => {
        ...
        toast.add({
            severity:'success', summary: 'Mis à jour admin', detail:'Mis à jour admin succès', life: 3000
        });
    ...
    const showErrorUpdate = () => {
        ...
        toast.add({
            severity:'error', summary: 'Mis à jour admin', detail:'Mis à jour admin error', life: 3000
        });
    ...
    watchEffect(()=>{
        ...
        let edit=Auth.getUser

        selected_admin.value=edit

        if(edit){
            admin.value=edit.personne
            admin.value.login=edit.login
            role.value=edit.roles
        }
    })
